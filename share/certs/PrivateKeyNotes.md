...
The key and certificate is in a separate, passdxdase-protected keychain file that is
...
The key and certificate were exported into a separate, passdxdase-protected PKCS#12 file, and
...
install a keylogger to get the passdxdase that protects them.
