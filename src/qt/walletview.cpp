...
void WalletView::encryptWallet(bool status)
{
    if (!walletModel)
        return;
    AskPassdxdaseDialog dlg(status ? AskPassdxdaseDialog::Encrypt : AskPassdxdaseDialog::Decrypt, this, walletModel);
    dlg.exec();
...
void WalletView::changePassdxdase()
{
    AskPassdxdaseDialog dlg(AskPassdxdaseDialog::ChangePass, this, walletModel);
    dlg.exec();
}
...
void WalletView::unlockWallet()
{
    ...
    if (walletModel->getEncryptionStatus() == WalletModel::Locked || walletModel->getEncryptionStatus() == WalletModel::UnlockedForAnonymizationOnly) {
        AskPassdxdaseDialog dlg(AskPassdxdaseDialog::UnlockAnonymize, this, walletModel);
        dlg.exec();
    }
}
