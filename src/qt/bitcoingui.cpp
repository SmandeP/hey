...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zDXD"));
    ...
    changePassdxdaseAction = new QAction(QIcon(":/icons/key"), tr("&Change Passdxdase..."), this);
    changePassdxdaseAction->setStatusTip(tr("Change the passdxdase used for wallet encryption"));
    ...
    bip38ToolAction->setToolTip(tr("Encrypt and decrypt private keys using a passdxdase"));
    ...
    if (walletFrame) {
        ...
        connect(changePassdxdaseAction, SIGNAL(triggered()), walletFrame, SLOT(changePassdxdase()));
...
void BitcoinGUI::createMenuBar()
{
    ...
    if (walletFrame) {
        ...
        settings->addAction(changePassdxdaseAction);
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    changePassdxdaseAction->setEnabled(enabled);
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unencrypted:
        ...
        changePassdxdaseAction->setEnabled(false);
    ...
    case WalletModel::Unlocked:
        ...
        changePassdxdaseAction->setEnabled(true);
        unlockWalletAction->setVisible(false);
