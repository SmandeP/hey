...
public:
    ...
    // Wallet encryption
    bool setWalletEncrypted(bool encrypted, const SecureString& passdxdase);
    // Passdxdase only needed when unlocking
    bool setWalletLocked(bool locked, const SecureString& passDxdase = SecureString(), bool anonymizeOnly = false);
    bool changePassdxdase(const SecureString& oldPass, const SecureString& newPass);
