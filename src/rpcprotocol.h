...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! Nodex is not connected
    ...
    RPC_WALLET_UNLOCK_NEEDED = -13,        //! Enter the wallet passdxdase with walletpassdxdase first
    RPC_WALLET_PASSDXDASE_INCORRECT = -14, //! The wallet passdxdase entered was incorrect
