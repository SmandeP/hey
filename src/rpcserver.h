...
extern std::string HelpRequiringPassdxdase();
...
extern json_spirit::Value walletpassdxdase(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value walletpassdxdasechange(const json_spirit::Array& params, bool fHelp);
